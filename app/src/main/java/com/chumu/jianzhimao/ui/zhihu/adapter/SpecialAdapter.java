...
public class SpecialAdapter extends RecyclerView.Adapter {
    ...
    public ArrayList<BeanSpecial.StoriesBean> mList = new ArrayList<>();
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, final int i) {
            ...
            Glide.with(mContext).load(mList.get(i).getImages().get(0)).into(holder.mImg);
    ...
    public void addlist(List<BeanSpecial.StoriesBean> list) {
        mList.addAll(list);
    }
