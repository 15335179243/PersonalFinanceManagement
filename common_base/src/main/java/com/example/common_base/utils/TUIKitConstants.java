...
public class TUIKitConstants {
    ...
    public static String APP_DIR = BaseApplication.getAppCacheDir() != null
            ? BaseApplication.getAppCacheDir()
            : SD_CARD_PATH + "/" + BaseApplication.getAppContext().getPackageName();
